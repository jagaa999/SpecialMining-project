...
const SectionLightingDecor = () => {
    return (
        <BlockDiv type="section" className="w-full flex flex-col lg:flex-row bg-[#1a1a1a] text-[#f1f1f1] py-20 px-8 lg:px-24">
            ...
            <BlockDiv className="w-full lg:w-1/2 space-y-6 lg:pl-10">
                <TextH3
                    value="04"
                    className="text-[#f6c99e] text-4xl font-semibold"
                />
                <TextH3
                    value="Гэрэлтүүлэг"
