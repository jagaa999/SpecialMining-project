...
const SectionTextile = () => {
    return (
        <BlockDiv type="section" className="w-full flex flex-col lg:flex-row bg-gradient-to-br from-[#1c1c1c] to-[#2a2a2a] text-white py-28 px-6 lg:px-32 gap-12">
...
const SectionFireplace = () => {
    return (
        <BlockDiv type="section" className="w-full flex flex-col lg:flex-row-reverse bg-gradient-to-br from-[#fdf5ef] to-[#f5eadd] text-[#1a1a1a] py-28 px-6 lg:px-32 gap-12">
            ...
            <BlockDiv className="w-full lg:w-1/2 px-4 lg:px-10 space-y-6">
                <TextH3
                    value="06"
                    className="text-[#e6b78d] text-5xl font-black"
                />
                <TextH3
                    value="Камин зуух"
