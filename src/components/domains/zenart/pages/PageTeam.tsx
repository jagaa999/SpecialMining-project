    ...
    return (
        <BlockDiv type="section" className="w-full flex flex-col lg:flex-row bg-[#101114] text-[#f1f1f1] py-20 px-8 lg:px-24">
            <BlockDiv className="w-full lg:w-1/2 space-y-4 lg:pr-10">
                ...
                <TextHtml
                    value="Бидний хамгийн чухал орон зай болох гэр, ажлын байр, болон үйлчилгээний талбайн төлөвлөлт, хана, шал, таазны өнгө болон хэлбэр дүрс, түүнчлэн тавилга, гэрэл, хөшиг зэрэг сонголтоос тав тухтай орчин бий болдог. Тиймээс интерьерийн зураг төсөл зохиох нь барилгын дизайнд суурилсан цогц үйл ажиллагааны нэгэн хэсэг юм. Манай компанийн мэргэжлийн чадварлаг мэргэжилтнүүдтэй баг өдөр тутмын хэв маяг, эргономик, кинетик, бионик, өнгө, инстинкт, функциональ шаардлагад нийцсэн дизайны төлөвлөгөөг боловсруулах чиглэлд ажилласаар байна."
    ...
    return (
        <BlockDiv type="section" className="w-full flex flex-col lg:flex-row bg-[#f7f2eb] text-[#222] py-20 px-8 lg:px-24">
            ...
            <BlockDiv className="w-full lg:w-1/2 space-y-4 lg:pl-10">
                ...
                />
                <TextHtml
                    value="Барилга бүтээн байгуулалтын ажил хийгдэж байгаа үед гүйцэтгэлийн баг интерьер, дотоод засал, гадна засал зэрэг бүхий л чиглэлд ажилладаг. Интерьер зураг төсөлөөр зассан гүйцэтгэл хийгдээгүй ашиглалт, төлөвлөлт муутай орон зай, ил замбараагүй цахилгааны угсралт, өнгө зохицолгүй орчныг бий болгох магадлал өндөр. Эдгээр алдаануудээс тооцоолоогүй орчин, хэт давхаржмалт тухай засал гүйцэтгэл үр ашиггүй зардал болдог."
                    className="text-[#2a2a2a] text-sm leading-6"
                />
                <TextHtml
                    value="Гүйцэтгэлийн багийн гол зорилго нь таны тав тухтай ажиллаж амьдрах орчныг бүрдүүлэх юм. Шилдэг мэргэжилтэн байтугай харин чадвартай мэргэжилтэн гэдэг бий. Иймд бид олон жилийн турш нэг баг болон ажиллаж байгаа туршлагатай, мэргэшсэн хүмүүстэйгээр үйл ажиллагаагаа явуулсаар байна."
                    className="text-[#2a2a2a] text-sm leading-6"
                />
            </BlockDiv>
        </BlockDiv>
