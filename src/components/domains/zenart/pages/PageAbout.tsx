    ...
    <BlockDiv
      ...
      <BlockDiv className="w-full lg:w-1/2 flex flex-col justify-center px-10 lg:px-24 py-12">
        <img
          ...
          alt="Zen Art Logo"
          className="w-10 mb-8 animate-fade-in"
        />
        <TextHtml
          ...
          className="text-slate-300 text-sm leading-7 tracking-wide mb-8 animate-slide-up"
        />
        <TextH3
          value="Таны уран бүтээлч амьдралын хэв маяг..."
          className="bg-gradient-to-r from-[#f6c99e] to-[#ce9871] bg-clip-text text-transparent text-xl font-semibold animate-fade-in"
        />
      </BlockDiv>
  ...
  return (
    <BlockDiv
      ...
      <BlockDiv className="w-full lg:w-1/2 px-12 py-16 flex flex-col justify-center">
        <TextH3
          value="БИДНИЙ ТУХАЙ"
          className="text-[#8c6a5d] uppercase text-sm tracking-widest mb-6 animate-fade-in"
        />
        <TextHtml
          value="Зэн Арт ХХК нь 2017 онд гэр ахуйн тавилгын худалдааны чиглэлээр үйл ажиллагаа эрхлэн байгууллагдсан. 2018 оноос эхлэн Интерьер, Экстерьер зураг төслийг иж бүрэн боловсруулан түүнтэй дагуу гүйцэтгэл хийж ажиллаж байна. Үл хөдлөх хөрөнгийн үнэ цэнийг тодорхойлох чухал нөлөөлөл бүхий интерьер дизайны үйлчилгээг үзүүлэхдээ дэлхийн жишигт нийцсэн шинэлэг дизайныг бүтээж байна. Өнөөдөр манай компанийн зураг төсөл, гүйцэтгэлийн чадамжтай мэргэжилтнүүдтэй хамтран орон сууц, оффис, үйлчилгээний байгууллагуудад 100 гаруй зураг төслийн чанарын өндөр түвшинд хийж гүйцэтгэсэн туршлагатай болсон.

Орчин үеийн амьдралын хэв маяг, дизайны чиг хандлага, интерьер зураг төсөл, декораци, гэрийн тохижилт, зөвлөгөө зэргийг дизайны иж бүрэн үйлчилгээг хэрэгцээнд санал болгодог Интерьер болон Арт студи юм."
          className="text-[#2a2a2a] text-base leading-7 tracking-wide animate-slide-up"
        />
  ...
  return (
    <BlockDiv
      ...
      <BlockDiv className="w-full lg:w-1/3 text-white p-10 flex flex-col justify-center">
        <TextH3
          value="БИДНИЙ ТУХАЙ"
          className="text-[#888] uppercase text-sm tracking-widest mb-4 animate-fade-in"
        />
        <TextH3
          value="Бид дараах чиглэлээр үйл ажиллагаагаа явуулдаг"
          className="text-[#f6c99e] text-lg font-bold mb-6 animate-fade-in"
        />
        <ul className="list-disc pl-6 space-y-3 text-base leading-7 animate-slide-up">
