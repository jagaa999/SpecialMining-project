...
export default function PageHome() {
  const { imageUrl, error } = useUnsplash("dental");
  const defaultImage =
    "https://images.unsplash.com/photo-1588776814546-ec7e8bb3c9f5";
...
>>>>>>> 98c98482c3b3f39ac000f0329670feaaefde1d40

      {/* Widget 1 - Intro */}
      <section className="max-w-screen-xl mx-auto py-24 px-6 text-center border-b">
        <h2 className="text-4xl font-bold mb-6 text-[#1d3557]">
          Бидний эрхэм зорилго
        </h2>
        <p className="text-xl leading-9 text-gray-700 max-w-4xl mx-auto">
          Японы стандарт, аргачлалаар өвдөлт багатай, хурдан шуурхай эмчилгээг
          үзүүлж, та бүхэнд итгэл, аюулгүй байдлыг мэдрүүлнэ.
        </p>
      </section>
      ...
      <section className="py-24 px-6 bg-[#f7f8fa] border-b">
        <div className="max-w-screen-xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <img
              src="https://cdn.moto.mn/moto/landing/04_mungundent/web_pics/09f32b5d-3153-4796-b50b-f96105ec1694.jpg?t=1749804114965l"
              alt="dental-clinic"
          ...
          <div>
            ...
            <p className="text-lg text-gray-700 mb-4">
              Зөвхөн 4 суулгац ашиглан бүхэл шүдийг нөхөн сэргээх боломжтой.
              Богино хугацаанд, байгалийн мэт шүдтэй болно.
            </p>
      ...
      <section className="py-24 px-6 bg-white border-b font-[Arial]">
        <div className="max-w-screen-xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-12 text-[#1d3557] tracking-wide">
            Бидний үйлчилгээ
          </h2>
          <div className="grid md:grid-cols-3 gap-10">
            {[
              ...
              <div
                ...
                <h3 className="text-xl font-bold text-[#1d3557] mb-2 group-hover:underline transition">
                  {service.title}
                </h3>
        ...
        <div className="max-w-screen-xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            <h2 className="text-3xl font-bold mb-4">
              Дэвшилтэт япон тоног төхөөрөмж
            </h2>
            <p className="text-lg text-gray-700 mb-4">
              CAD/CAM, 3D рентген зэрэг Япон улсаас шууд оруулсан өндөр
              нарийвчлалтай багаж хэрэгсэл ашигладаг.
            </p>
            <ul className="list-disc list-inside text-left text-gray-600 space-y-1">
          ...
          <div className="order-1 md:order-2">
            <img
              src="https://cdn.moto.mn/moto/landing/04_mungundent/web_pics/bc0f6f78-1953-4e51-9a46-65d902b667c8.jpg?t=1749804181553"
              alt="dental-clinic"
              className="rounded-lg shadow-xl"
            />
          </div>
      ...
      <section className="py-24 px-6 bg-white text-center border-b">
        <h2 className="text-3xl font-bold mb-6 text-[#1d3557]">
          Мэргэжлийн эмчийн зөвлөгөө
        </h2>
        <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-10">
          Танд хамгийн тохирсон эмчилгээг сонгоход туршлагатай эмч нар маань
          туслах болно.
        </p>
        <img
          src="https://cdn.moto.mn/moto/landing/04_mungundent/web_pics/c055dd13-8186-4cc0-982e-56654d06b710.jpg?t=1749804311899"
          alt="dental-clinic"
          ...
          <div className="grid md:grid-cols-2 gap-8 text-left">
            <div className="bg-[#f7f8fa] p-6 rounded-xl shadow hover:shadow-md transition duration-300">
              <p className="text-gray-700 italic">
                Мөнгөндент-т ирсэн цагаас л сэтгэл амар байлаа. Эмч нар маш
                чадварлаг, орчин нь ч тухтай.”
              </p>
              <span className="mt-4 block font-bold text-[#1d3557]">
                — Батцэцэг
              </span>
            </div>
            <div className="bg-[#f7f8fa] p-6 rounded-xl shadow hover:shadow-md transition duration-300">
              <p className="text-gray-700 italic">
                “Япон хэв маягтай цэвэрхэн орчинд, маш тайвнаар эмчлүүлсэндээ
                баяртай байна.”
              </p>
              <span className="mt-4 block font-bold text-[#1d3557]">
                — Тэмүүлэн
