  ...
  return (
    <main className="w-full">
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        {/* Overlay content */}
        <div
          className={`relative z-10 flex flex-col justify-center items-center h-full text-white text-center px-4 transition-all duration-700 ${
          ...
          {slides.map((_, idx) => (
            <div
              ...
              className={`w-3 h-3 rounded-full transition-all ${
                currentSlide === idx ? "bg-white scale-110" : "bg-gray-400"
              }`}
            />
          ))}
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center justify-center h-full">
          ...
          <motion.div
            ...
            <p className="text-lg leading-relaxed">
              Гуанжөү Автомашины Групп ХХК (GAC) нь 1997 оны 6-р сард
              байгуулагдсан. 2023 онд тус компанийн үйлдвэрлэл болон борлуулалт
              хоёулаа 2.5 саяас давж, өмнөх оныхоос өсөлттэй, эерэг үзүүлэлттэй
              гарсан байна.
            </p>
      ...
      <section className="relative w-full bg-black text-white px-6 h-screen pb-24">
        {" "}
        {/* pb-24 added here */}
        <div className="max-w-7xl mx-auto h-full flex flex-col justify-center items-center text-center space-y-10">
          ...
          <motion.div
            ...
            <p className="text-base md:text-lg text-gray-300 leading-relaxed max-w-5xl mx-auto text-center">
              {" "}
              {/* max-w updated */}
              GAC-ийн Судалгаа, Хөгжлийн Төвд бид дараах дөрвөн чиглэлээр
              томоохон ахиц гаргахыг зорьж, технологийн шинэчлэлд улам их
              хөрөнгө оруулалт хийхээр төлөвлөж байна. Бид технологийн хөгжлөөр
              дамжуулан бүтээгдэхүүний хөгжлийг улам хүчирхэгжүүлж байна.
            </p>
