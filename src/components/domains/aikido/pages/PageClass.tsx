        ...
        <div className="w-full bg-white text-gray-900">
            ...
            <AikidoHomeHero
                item={{
                    ...
                    subtitle: "Өөртөө итгэх итгэл, сахилга бат, хамгаалалтын урлагийг нэг дороос",
                    buttons: [
                        {
                            label: "Хичээллэх",
                            href: "/register",
            ...
            <section className="bg-white px-10 py-20">
                ...
                <div className="flex flex-wrap justify-center gap-10">
                    {[
                        {
                            name: "Сэнсэй Баяр",
                            image: "https://cdn.moto.mn/moto/landing/11_aikido/dcb9e1e0-a177-4f46-9c20-6ed456968454.png?t=1749545071271",
                            rank: "2-р дан хар бүс",
                            desc: "Японд 5 жил суралцсан, олон улсын тэмцээний оролцогч",
                        },
                        {
                            name: "Сэнсэй Энхээ",
                            image: "https://cdn.moto.mn/moto/landing/11_aikido/8c69e6df-4851-4164-8680-77199a72992d.png?t=1749545291104",
            ...
            <section className="bg-red-600 text-white text-center px-10 py-20">
                <h2 className="text-4xl font-bold mb-4">Та хичээллэхийг хүсэж байна уу?</h2>
