    ...
    <BlockDiv className="w-full bg-gradient-to-br from-[#fffdfc] to-[#f7f4f2] py-24 px-6 md:px-20 text-[#1a1a1a]">
      ...
      <TextHtml
        value={`<h2 class='text-4xl md:text-5xl font-extrabold text-center leading-snug mb-10'>
          Бид <span class='text-brand'>хэн</span> бэ?
        </h2>`}
      />
      ...
      <BlockDiv className="max-w-4xl mx-auto text-center text-lg text-gray-700 leading-relaxed space-y-6">
        <p>
          <strong>Kiosk.mn</strong> бол технологийн хэрэглээ, UI/UX дизайн, веб
          болон киоск систем хөгжүүлэлтэд төвлөрсөн бүтээлч баг юм. Бид
          технологийг зөвхөн код биш —{" "}
          <span className="italic">
            бодит хэрэглэгчийн мэдрэмж, сэтгэл ханамж
          </span>
          -ийн үндсэн дээр бүтээдэг.
        </p>
        <p>
          Бид төслийг цаасан дээрээс эхлүүлээд бүтээгдэхүүн болтол нь цогц
          байдлаар хөгжүүлдэг. Үйлчлүүлэгчийнхээ брэндийг зөв танилцуулж, зөв
          мэдрэмж төрүүлэх интерфэйс бүтээх нь бидний хамгийн гол зорилго.
        </p>
        <p>
          Өнгөрсөн хугацаанд 10+ киоск интерфэйс, 20+ вэб сайт, 5+ ERP системийг
          амжилттай хүлээлгэн өгсөн туршлагатай. Бидний бүтээл бүр
      ...
      <BlockDiv className="mt-20 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          ...
          <BlockDiv
            ...
            <TextH3 value={item.icon} className="text-3xl" />
            <TextH3
              value={item.title}
      ...
      <BlockDiv className="mt-24 text-center">
        <TextHtml
          value={`<p class="text-lg md:text-xl font-medium text-gray-800">
            Та бидэнтэй хамтран <span class="text-brand font-bold">шинэлэг технологийн шийдэл</span> бүтээхэд бэлэн үү?
          </p>`}
        />
        <RenderAtom
          url={{ href: "/contact" }}
          className="inline-block mt-6 px-8 py-3 bg-brand text-white text-sm font-semibold rounded-full hover:bg-orange-600 transition"
          value="Холбоо барих"
        />
      </BlockDiv>
    </BlockDiv>
