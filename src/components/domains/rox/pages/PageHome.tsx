...
export default function PageHome() {
    ...
    const [thirdRef, inViewThird] = useInView({ triggerOnce: false });
            ...
            >
                ...
                >
                    ...
                    <p className="text-white text-base md:text-lg leading-snug drop-shadow-lg">
                        The vehicle features sharp body lines and a straight roof, creating a bold and classic silhouette that delivers a strong, powerful presence.
                    </p>
                </motion.div>
            </motion.section>
