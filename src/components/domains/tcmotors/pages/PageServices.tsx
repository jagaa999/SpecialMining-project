        ...
        <>
            <TcmotorsHomeHero
                item={{
                    ...
                    subtitle: "Таны машины найдвартай хамтрагч — хурдан, хямд, баталгаатай",
                    buttons: [
                        {
            ...
            <PanelMain className="flex flex-col items-start gap-14">
                ...
                <BlockDiv type="section" className="bg-red-50 rounded-xl shadow-md p-8 w-full">
                    <h2 className="text-2xl font-bold text-red-600 mb-4 text-center">Яагаад биднийг сонгох вэ?</h2>
                ...
                <BlockDiv type="section" className="bg-blue-100 rounded-xl shadow-md p-8 w-full">
                    <h2 className="text-2xl font-bold text-blue-600 mb-6 text-center">Хэрэглэгчдийн үнэлгээ</h2>
                    <div className="space-y-6 text-gray-700">
                        <blockquote className="border-l-4 border-blue-400 pl-4 italic">
                            “Түгээлт маш хурдан ирсэн. Хуучин сэлбэг гэмтэлгүй, яг таарсан!” — <b>Б. Ганбаатар</b>
                        </blockquote>
                        <blockquote className="border-l-4 border-blue-400 pl-4 italic">
                            “Эндэхийн зөвлөх яг оношлоод зөв сэлбэг санал болгосон. Маш их баярласан!” — <b>О. Энхмаа</b>
                        </blockquote>
                        <blockquote className="border-l-4 border-blue-400 pl-4 italic">
                            “Үнийн хувьд хамгийн боломжийн газар байсан. Баталгаат хугацаа ч байдаг нь том давуу тал.” — <b>Ц. Ариунболд</b>
                        </blockquote>
                    </div>
                </BlockDiv>
            </PanelMain>
