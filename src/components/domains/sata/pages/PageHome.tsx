...
const PageHome = () => {
    ...
    const bgImage = imageUrl || "https://cdn.moto.mn/moto/landing/14_sata/8e7226f3-3a26-4bcc-bceb-c0395aa35317.jpg?t=1751340548285";
            ...
            <main className="w-full">
                ...
                >
                    ...
                    <div className="relative z-10 max-w-4xl mx-auto space-y-6">
                        ...
                        <p className="text-lg md:text-xl text-white/90">
                            Ажлыг хөнгөвчлөх хүчирхэг сонголт — SATA Tools Mongolia танд дэлхийн түвшний хэрэгслийг санал болгож байна.
                        </p>
                ...
                <section className="bg-white py-24 px-6 lg:px-20">
                    <div className="max-w-screen-xl mx-auto space-y-16">
                        <div className="text-center">
                            <h2 className="text-4xl font-extrabold text-gray-900 mb-4">SATA бол сонголт биш — Шийдвэр юм</h2>
                            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
                                Бидний үнэт зүйлс мэргэжлийн хэрэглэгчдийн амжилтыг тодорхойлдог.
                            </p>
                        </div>
                ...
                <section className="bg-gray-100 py-20">
                    <div className="max-w-screen-xl mx-auto px-6 lg:px-20">
                        <h2 className="text-3xl font-bold text-gray-800 text-center mb-12">Онцлох бүтээгдэхүүнүүд</h2>
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                            {[
                                {
                                    name: "Түлхүүр ком",
                                    image: "https://res.cloudinary.com/dg2qmka48/image/upload/v1751341917/autozar6/mainimages/2025/sata/jinhen_tulhuurcom_kmejgn.jpg",
                                    desc: "Хамгийн их борлуулалттай гар багажны багц.",
                                    price: "₮129,000",
                                },
                                {
                                    name: "Socket Set 40PCS",
                                    image: "https://res.cloudinary.com/dg2qmka48/image/upload/v1751341917/autozar6/mainimages/2025/sata/tulhuurcom_ewjso3.jpg",
                                    desc: "Мэргэжлийн хэрэглээнд тохирсон олон төрлийн socket.",
                                    price: "₮98,000",
                                },
                                {
                                    name: "Отверка сет",
                                    image: "https://res.cloudinary.com/dg2qmka48/image/upload/v1751341917/autozar6/mainimages/2025/sata/awtirk_c4rj19.webp",
                ...
                <section className="py-20 px-6 text-center bg-white">
                    <div className="max-w-screen-md mx-auto">
                        <h2 className="text-3xl font-bold mb-8">Яагаад SATA-г сонгох вэ?</h2>
                ...
                <section className="bg-gradient-to-r from-green-600 to-green-800 text-white py-20 px-6">
                    <div className="max-w-screen-xl mx-auto grid md:grid-cols-2 gap-12 items-center">
                        <div className="space-y-6">
                            <h2 className="text-4xl font-bold">Ажлыг мэргэжлийн түвшинд — SATA TOOLS</h2>
                            <p className="text-lg text-white/90">
                                Засвар, угсралт, авто болон үйлдвэрлэлийн салбарт хамгийн чухал зүйл бол зөв багаж.
                                SATA нь таны ажлын итгэлтэй түнш байх болно.
                                Өндөр чанар, бат бөх байдал, мэргэжлийн хэрэглээнд зориулагдсан шийдэл — энэ бол SATA.
                            </p>
                        </div>
