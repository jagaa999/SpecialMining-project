...
export function toCozyDate(myDate: any) {
...
export function toCozyPrice(myPrice: any) {
...
export function toCozyKm(myKm: any) {
...
export function jsonParseV3(json: any, isDecode: boolean, changeQuote = false) {
  ...
  try {
    ...
    llog("jsonParseV3 - Алдаа гарчэээ", { error: ex, json });
    return json;
  }
}
